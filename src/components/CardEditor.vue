<template>
  <Transition name="editor">
    <div v-if="visible" class="editor-overlay">
      <div :style="{ transformOrigin: editorOrigin }" :class="['editor-sheet', fullscreen ? 'editor-sheet--fullscreen' : '', shouldUseDarkTheme ? 'editor-sheet--dark' : '']">

        <header :class="['editor-header', shouldUseDarkTheme ? 'editor-header--dark' : '']">
            ...
            <div class="flex items-center gap-2 flex-1 min-w-0">
              <div class="relative" ref="categoryDropdownRef">
                <button
                  ...
                  :class="['editor-cat-btn', shouldUseDarkTheme ? 'editor-cat-btn--dark' : '']"
                >
                ...
                <Tag :size="12" :class="['absolute left-2 top-1/2 -translate-y-1/2 pointer-events-none', shouldUseDarkTheme ? 'text-blue-400' : 'text-blue-500']" />
                <div
                  v-if="showCategoryDropdown"
                  :class="['editor-dropdown', shouldUseDarkTheme ? 'editor-dropdown--dark' : '']"
                >
                  <button
                    @click="editCategoryId = null; showCategoryDropdown = false"
                    :class="['editor-dropdown-item', shouldUseDarkTheme ? 'editor-dropdown-item--dark' : '', editCategoryId === null ? 'editor-dropdown-item--active' : '']"
                  >
                  ...
                  <button
                    ...
                    :class="['editor-dropdown-item', shouldUseDarkTheme ? 'editor-dropdown-item--dark' : '', editCategoryId === cat.id ? 'editor-dropdown-item--active' : '']"
                  >
              ...
              <div :class="['editor-source-input', shouldUseDarkTheme ? 'editor-source-input--dark' : '']">
                <Link :size="12" :class="['shrink-0', shouldUseDarkTheme ? 'text-slate-500' : 'text-slate-400']" />
                <input
                  v-model="editSource"
                  type="url"
        ...
        <div v-if="panel === 'front'" class="flex-1 flex overflow-hidden">
          <div :class="['editor-panel-left', shouldUseDarkTheme ? 'editor-panel-left--dark' : '']">
            ...
            <div class="flex-1 p-5 flex gap-3 font-mono text-sm leading-relaxed overflow-hidden">
              ...
              <textarea
                ...
                :class="['flex-1 bg-transparent border-none outline-none resize-none custom-scrollbar overflow-y-auto focus:ring-0 p-0', shouldUseDarkTheme ? 'text-slate-200' : 'text-slate-800']"
              />
            </div>
          </div>
          ...
          <div :class="['editor-panel-right', shouldUseDarkTheme ? 'editor-panel-right--dark' : '']">
            ...
            <div
              ref="frontPreviewRef"
              :class="['flex-1 p-8 overflow-y-auto custom-scrollbar select-text', shouldUseDarkTheme ? 'markdown-preview markdown-preview-dark' : 'markdown-preview']"
              v-html="frontHtml"
            />
          </div>
        </div>
